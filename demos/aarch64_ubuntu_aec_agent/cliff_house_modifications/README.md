# cliff_house_modifications

The validated Cliff House workflow for controlled, reversible modifications, with separate
playbooks for Windows/Rhino and NVIDIA DGX Spark/FreeCAD.
