...
$slug = 'cliff-house-modifications-windows'
& $hermes --profile $Profile project show $slug *> $null
if ($LASTEXITCODE -ne 0) {
  & $hermes --profile $Profile project create 'Cliff House Modifications Windows' $root --slug $slug --primary $root --description 'Quick reversible Rhino and Blender modifications.' --icon building --color '#76b900'
